...
- **ffmpeg:** Required by the PodcastAudio step to convert the generated audio to MP3. Install via your package manager (e.g. `brew install ffmpeg`, `sudo apt install ffmpeg`, or `winget install ffmpeg`).
